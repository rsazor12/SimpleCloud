...
namespace MachineLearning_SimpleCloud_Broker.Application.Common.Behaviours
{
    public class RequestPerformanceBehaviour<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse>
    {
        ...
        private readonly Payment_SimpleCloud_MicroservicesMessageBroker.ClientTasksClient _paymentClientsHttpClient;
            ...
            IOptions<AppSettings> settings)
        {
            ...
            _paymentClientsHttpClient = new Payment_SimpleCloud_MicroservicesMessageBroker.ClientTasksClient(new HttpClient()) { BaseUrl = _appSettings.PaymentApi };
        ...
        public async Task<TResponse> Handle(TRequest request, CancellationToken cancellationToken, RequestHandlerDelegate<TResponse> next)
        {
            ...
            //    _logger.LogWarning("MachineLearning_SimpleCloud_Broker Long Running Request: {Name} ({ElapsedMilliseconds} milliseconds) {@UserId} {@UserName} {@Request}",
        ...
        {
            await _paymentClientsHttpClient.CreateClientAsync(new Payment_SimpleCloud_MicroservicesMessageBroker.AddClientTaskCommand() { ClientEmail = client.Email, TaskName = taskName, StartTIme = startTime, EndTime = endTime});
        }
    }
}
