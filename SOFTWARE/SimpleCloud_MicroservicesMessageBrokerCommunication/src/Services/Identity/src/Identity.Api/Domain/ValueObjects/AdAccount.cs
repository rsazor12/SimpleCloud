using Identity_SimpleCloud_MicroservicesMessageBroker.Domain.Common;
using Identity_SimpleCloud_MicroservicesMessageBroker.Domain.Exceptions;
using System;
using System.Collections.Generic;

namespace Identity_SimpleCloud_MicroservicesMessageBroker.Domain.ValueObjects
{
