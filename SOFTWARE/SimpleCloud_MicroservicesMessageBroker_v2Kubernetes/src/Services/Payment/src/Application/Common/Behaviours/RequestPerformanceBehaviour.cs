...
//using Payment_SimpleCloud_MicroservicesHttp.Application.Common.CQRS;
...
//namespace Payment_SimpleCloud_MicroservicesHttp.Application.Common.Behaviours
//{
...
//            //    _logger.LogWarning("Payment_SimpleCloud_MicroservicesHttp Long Running Request: {Name} ({ElapsedMilliseconds} milliseconds) {@UserId} {@UserName} {@Request}",
