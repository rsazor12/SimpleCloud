using MachineLearning_SimpleCloud_MicroservicesHttp.Domain.Common;
using MachineLearning_SimpleCloud_MicroservicesHttp.Domain.Exceptions;
using System;
using System.Collections.Generic;

namespace MachineLearning_SimpleCloud_MicroservicesHttp.Domain.ValueObjects
{
