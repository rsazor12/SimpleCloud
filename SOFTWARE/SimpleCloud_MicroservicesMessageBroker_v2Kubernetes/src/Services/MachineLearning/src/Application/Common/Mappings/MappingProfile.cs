...
namespace MachineLearning_SimpleCloud_MicroservicesHttp.Application.Common.Mappings
{
    public class MappingProfile : Profile
    {
        ...
        private void ApplyMappingForEntities()
        {
            var assembly = AppDomain
                .CurrentDomain
                .GetAssemblies()
                .SingleOrDefault(assembly => assembly.GetName().Name == "MachineLearning_SimpleCloud_MicroservicesHttp.Domain");
