...
namespace SimpleCloud_Monolithic.Infrastructure.Migrations
{
    ...
    [Migration("20200515135721_AddClientProperties")]
    partial class AddClientProperties
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SimpleCloudMonolithic.Infrastructure.Identity.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SimpleCloudMonolithic.Infrastructure.Identity.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SimpleCloud_Monolithic.Domain.Entities.ServiceTask", b =>
                {
                    b.HasOne("SimpleCloud_Monolithic.Domain.Entities.ServiceDetails", null)
